...
| 原型 | 在线预览地址 |
|------|-------------|
| 学员端（移动端手机壳） | `https://USERNAME.github.io/REPO/prototype/营销导购陪练智能体-学员端.html` |
| 管理端（B 端后台） | `https://USERNAME.github.io/REPO/prototype/营销导购陪练智能体-管理端.html` |
| 信息架构图（8 大域 · 字段级设计） | `https://USERNAME.github.io/REPO/prototype/AI销售陪练系统-信息架构图.html` |
| 功能模块图（6 大模块 · 交互思维导图） | `https://USERNAME.github.io/REPO/prototype/AI销售陪练系统-功能模块图.html` |
...
| 文档 | 说明 |
|------|------|
| [营销导购AI陪练系统-PRD.md](docs/营销导购AI陪练系统-PRD.md) | V1.1 完整产品需求文档（14 章 / 707 行） |
